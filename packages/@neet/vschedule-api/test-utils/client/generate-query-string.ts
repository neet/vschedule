// https://github.com/Himenon/openapi-typescript-code-generator/blob/main/example/utils.ts
import * as Formatter from '@himenon/openapi-parameter-formatter';
import { QueryParameters } from '@neet/vschedule-api-client';
  ...
  const queries = Object.entries(queryParameters).reduce<string[]>(
    (queryStringList, [key, item]) => {
      ...
      const result = Formatter.QueryParameter.generate(
        key,
        item as Formatter.QueryParameter.Parameter,
      );
      if (result) {
