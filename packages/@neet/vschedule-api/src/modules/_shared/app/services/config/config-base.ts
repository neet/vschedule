...
abstract class __ConfigBase {
  private readonly entries: IConfig;

  public constructor(entries: PartialDeep<IConfig>) {
    this.entries = {
      storage: {
...
type AbstractCtor = abstract new (
  ...args: ConstructorParameters<typeof __ConfigBase>
) => IConfig;

const ConfigBase = __ConfigBase as unknown as AbstractCtor;
export { ConfigBase };
