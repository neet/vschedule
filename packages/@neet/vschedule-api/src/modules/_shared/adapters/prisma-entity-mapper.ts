...
import { Actor, Timestamps } from '../../../modules/_shared/domain';
import { MediaAttachment } from '../../../modules/media-attachments/domain';
import { Organization } from '../../../modules/organizations/domain';
import { Performer } from '../../../modules/performers/domain';
import { Stream } from '../../../modules/streams/domain';
import { Token } from '../../../modules/tokens/domain';
...
export const rehydrateMediaAttachmentFromPrisma = (
  ...
  return MediaAttachment.rehydrate({
    ...
    blurDataUri: mediaAttachment.base64,
